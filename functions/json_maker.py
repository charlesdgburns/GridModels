...
REWARD_SIZE2DUR = {"25uL": 0, "20uL": 0, "15uL": 0, "12uL": 0, "10uL": 0, "8uL": 0}
...
def save_exp_info():
    with open("/content/drive/MyDrive/Colab Notebooks/Doohan/mEC_experiment_info.json", "w", encoding='utf-8') as outfile:
